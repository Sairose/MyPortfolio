...
export default function Links() {
  return (
    <div className='flex gap-4'>
        <a href="https://www.youtube.com/"  className='w-[40px] h-[40px] border-2 border-[#30C1BA] rounded-full flex justify-center items-center duration-500 hover:bg-[#30C1BA] hover:translate-x-[-4px] hover:translate-y-[-4px]'><FaFacebookF/></a>
